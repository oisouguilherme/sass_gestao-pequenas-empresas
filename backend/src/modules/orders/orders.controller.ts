...
export async function updateStatus(req: Request, res: Response) {
  res.json(await service.updateStatus(req.user!, req.params.id, req.body.status))
}

export async function setUsuarios(req: Request, res: Response) {
  res.json(await service.setUsuarios(req.user!, req.params.id, req.body.usuarioIds))
}

export async function setProdutos(req: Request, res: Response) {
  res.json(await service.setProdutos(req.user!, req.params.id, req.body.produtos))
}
