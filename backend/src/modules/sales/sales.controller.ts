...
export async function removeItem(req: Request, res: Response) {
  res.json(await service.removeItem(req.user!, req.params.id, req.params.produtoId))
}

export async function setDiscount(req: Request, res: Response) {
  res.json(await service.setDiscount(req.user!, req.params.id, req.body.desconto))
}

export async function finalize(req: Request, res: Response) {
  res.json(await service.finalize(req.user!, req.params.id, req.body.tipoPagamento))
}
