...
export async function refresh(rawRefreshToken: string | undefined, meta: ClientMeta) {
...
async function issueTokens(
  usuario: { id: string; empresaId: string; role: 'ADMIN' | 'VENDEDOR' | 'OPERADOR'; nome: string; email: string },
  meta: ClientMeta,
) {
